...
//   // ✅ Handles both text & image updates
//   const handleUpdate = async (id, updatedProduct, newImages = []) => {
//     try {
//       let res;

//       if (newImages.length > 0) {
//         // Update with new images (FormData)
//         const formData = new FormData();
...
//                       value={p.productName}
//                       onChange={(e) =>
//                         handleChange(p._id, "productName", e.target.value)
//                       }
//                     />
//                   </td>
//                   <td>
...
//                       onChange={(e) =>
//                         handleChange(p._id, "productPrice", e.target.value)
//                       }
//                     />
//                   </td>
//                   <td>
...
//                       value={p.description}
//                       onChange={(e) =>
//                         handleChange(p._id, "description", e.target.value)
//                       }
//                     />
//                   </td>
//                   <td>
...
//                       onChange={(e) =>
//                         handleChange(p._id, "productCount", e.target.value)
//                       }
//                     />
//                   </td>
//                   <td>
...
//                     <button
//                       onClick={() =>
//                         handleUpdate(p._id, p, [newImage1, newImage2].filter(Boolean))
//                       }
//                     >
//                       ✅ Update
//                     </button>
...
function AdminPanel() {
  ...
  // 🆕 store image updates for each product by ID
