...
export default function Cart() {
  ...
  useEffect(() => {
    const fetchCart = async () => {
      setLoading(true);
      try {
        const res = await fetch("https://e-com-project-1-db0p.onrender.com/cart/get", {
          method: "GET",
  ...
  const fetchAddresses = async () => {
    try {
      const res = await fetch("https://e-com-project-1-db0p.onrender.com/address/get", {
        method: "GET",
        credentials: "include",
      });
      const data = await res.json();
  ...
  async function updateQuantity(productId, action) {
    ...
    try {
      const res = await fetch("https://e-com-project-1-db0p.onrender.com/cart/update", {
        method: "POST",
        credentials: "include",
  ...
  const handleSendOtp = async () => {
    ...
    try {
      const res = await fetch("https://e-com-project-1-db0p.onrender.com/otp/send", {
        method: "POST",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      const res = await fetch("https://e-com-project-1-db0p.onrender.com/otp/verify", {
        method: "POST",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
  ...
  const handleAddAddress = async () => {
    ...
    try {
      const res = await fetch("https://e-com-project-1-db0p.onrender.com/address/add", {
        method: "POST",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
